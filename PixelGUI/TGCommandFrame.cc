...
ClassImp(TGCommandFrame)

//______________________________________________________________________________
TGCommandFrame::TGCommandFrame(const TGCompositeFrame *p, UInt_t w, UInt_t h) :
      TGCompositeFrame(p, w, h)
{
   // TGCommandFrame Constructor.
   ...
   fCommand->Connect("ReturnPressed()", "TGCommandFrame", this,
                     "HandleCommand()");
...
//______________________________________________________________________________
void TGCommandFrame::CheckRemote(const char * /*str*/)
{
...
//______________________________________________________________________________
void TGCommandFrame::HandleCommand()
{
...
//______________________________________________________________________________
Bool_t TGCommandFrame::HandleTimer(TTimer *t)
{
   // Handle timer event.
